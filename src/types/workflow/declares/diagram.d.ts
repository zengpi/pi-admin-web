...
declare module "diagram-js/lib/core/Canvas" {
  ...
  export default class Canvas {
     ...
     * @returns {Base | Object}
     */
    setRootElement<E extends Base>(
      rootElement: E | Object,
      override?: boolean
    ): E | Object;
...
declare module "diagram-js/lib/core/EventBus" {
  ...
  export type EventType<
    T extends string,
    E extends Base
  > = EventMap<E> extends Record<T, infer P> ? P : InternalEvent;
...
declare module "diagram-js/lib/draw/DefaultRenderer" {
  ...
  export default class DefaultRenderer extends BaseRenderer {
    constructor(
      eventBus: EventBus,
      styles: Styles,
      DEFAULT_RENDER_PRIORITY?: number
    );
    CONNECTION_STYLE: Traits;
    SHAPE_STYLE: Traits;
    FRAME_STYLE: Traits;
    canRender(): boolean;
    drawShape<E extends Shape>(
      visuals: SVGElement,
      element: E,
      attrs?: Object
    ): SVGRectElement;
...
declare module "diagram-js/lib/model" {
  ...
  export type create = <T extends keyof CreateTypes>(
    type: T,
    attrs: Object
  ) => CreateTypes[T];
}
...
declare module "diagram-js/lib/features/context-pad/ContextPad" {
  ...
  export default class ContextPad extends ModuleConstructor {
     ...
     */
    registerProvider(
      priority: number | ContextPadProvider,
      provider?: ContextPadProvider
    ): void;
    /**
     * 返回对应元素可用的上下文菜单项
     * @param {Base} element
    ...
    _getPosition(element: Base | Base[]): {
...
declare module "diagram-js/lib/features/editor-actions/EditorActions" {
  ...
  export default class EditorActions extends ModuleConstructor {
     ...
     */
    register(
      actions: string | Record<string, Function>,
      listener?: Function
    ): void;
    // 触发操作
...
declare module "diagram-js/lib/features/palette/Palette" {
  ...
  export default class Palette extends ModuleConstructor {
    ...
    registerProvider(
      priority: number | PaletteProvider,
    ...
    _needsCollapse(
      ...
      entries: PaletteEntryDescriptor[]
    ): boolean;
...
declare module "diagram-js/lib/features/selection/Selection" {
  ...
  export default class Selection extends ModuleConstructor {
    ...
    select(
      elements: SelectedElement | Array<SelectedElement>,
      add?: boolean
    ): void;
...
declare module "diagram-js/lib/features/snapping/ResizeSnapping" {
  ...
  import SnapContext, {
    SnapPoints,
  } from "diagram-js/lib/features/snapping/SnapContext";
  import { Connection, Shape } from "diagram-js/lib/model";
...
declare module "diagram-js/lib/features/auto-place/AutoPlaceUtil" {
  ...
  export function getConnectedAtPosition(
    source: Shape,
    position: Point,
    element: Element
  ): Shape;
...
declare module "diagram-js/lib/features/bendpoints/BendpointUtil" {
  ...
  export function getConnectionIntersection(
    canvas: Canvas,
    waypoints: Point[],
    event: Event
  ): void;
  ...
  export function getClosestPointOnConnection(
    position: Position,
    connection: Connection
  ): Point;
}
...
declare module "diagram-js/lib/features/bendpoints/GeometricUtil" {
  ...
  export function getDistancePointLine(
    point: Point,
    line: [Point, Point]
  ): number;
...
declare module "diagram-js/lib/util/AttachUtil" {
  ...
  export function getNewAttachPoint(
    point: Point,
    oldBounds: Bounds,
    newBounds: Bounds
  ): Point;
  export function getNewAttachShapeDelta(
    shape: Shape,
    oldBounds: Bounds,
    newBounds: Bounds
  ): Point;
...
declare module "diagram-js/lib/util/Geometry" {
  ...
  export function pointsAlignedHorizontally(
    a: Point | Point[],
    b: Point
  ): boolean;
  export function pointsAlignedVertically(
    a: Point | Point[],
    b: Point
  ): boolean;
...
declare module "diagram-js/lib/util/LineIntersection" {
  ...
  export function getApproxIntersection(
    waypoints: Point[],
    reference: Point
  ): ApproxIntersection;
}
