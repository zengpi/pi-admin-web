...
declare module "bpmn-js/lib/import/BpmnImporter" {
  ...
  export default class BpmnImporter extends ModuleConstructor {
    ...
    //将边界元素附加到给定的主机
    protected _attachBoundary(
      boundarySemantic: ModdleElement,
      boundaryElement: Base
    ): void;
...
declare module "bpmn-js/lib/features/modeling/Modeling" {
  ...
  type Properties = Record<
    string,
    string | number | boolean | ModdleElement | null | undefined
  >;
...
declare module "bpmn-js/lib/features/modeling/ElementFactory" {
  ...
  export default class ElementFactory extends DiagramElementFactory {
    ...
    createBpmnElement<E extends Base>(
      elementType: string,
      attrs?: Object
    ): E & ModdleElement;
...
declare module "bpmn-js/lib/features/copy-paste/ModdleCopy" {
  ...
  export default class ModdleCopy extends ModuleConstructor {
     ...
     * @returns {*}
     */
    copyProperty<T extends ModdleElement, U>(
      property: U,
      parent: T,
      propertyName: string
    ): U;
...
declare module "bpmn-js/lib/features/auto-place/BpmnAutoPlaceUtil" {
  ...
  //始终尝试在源代码的右上方放置文本注释。
  export function getTextAnnotationPosition(
    source: Shape,
    element: Shape
  ): Point;
  //始终将元素放在source的右下方。
...
declare module "bpmn-js/lib/util/DiUtil" {
  ...
  export function hasErrorEventDefinition(
    element: Base | ModdleElement
  ): boolean;
  export function hasEscalationEventDefinition(
    element: Base | ModdleElement
  ): boolean;
  export function hasCompensateEventDefinition(
    element: Base | ModdleElement
  ): boolean;
}
