 ...
 * @return 用户
 */
function getUsers(query: Query): AxiosPromise<Page<User>> {
 ...
 * @param userForm 用户表单
 */
function saveUser(userForm: UserForm): AxiosPromise<null> {
 ...
 * @param userForm 用户表单
 */
function updateUser(userForm: UserForm): AxiosPromise<null> {
 ...
 */
function deleteUser(ids: string): AxiosPromise<null> {
 ...
 * @param profile 个人信息
 */
function profileEdit(profile: Profile): AxiosPromise<null> {
 ...
 */
function resetPass(id: number): AxiosPromise<null> {
...
function getOptionalUsers(
  query: OptionalUserQuery
): AxiosPromise<Page<OptionalUser>> {
